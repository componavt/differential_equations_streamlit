...
st.markdown("Select parameters to display animated solutions for each method.")
    ...
    for alpha in alpha_list:
        ...
        for idx, method in enumerate(methods):
            ...
            with cols[col]:
                ...
                # Filter solutions for current alpha, selected gamma1, gamma2, and method
                filtered = [
                    d for d in data
